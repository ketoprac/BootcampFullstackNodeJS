...
function totalGaji(gaji1, gaji2, gaji3) {
  const totalGaji1 = gaji1 + gaji1 * taxGaji(gaji1);
  const totalGaji2 = gaji2 + gaji2 * taxGaji(gaji2);
  const totalGaji3 = gaji3 + gaji3 * taxGaji(gaji3);
  ...
  return `
    ...
    Emp1 : Rp.${gaji3} + Pajak(10%)=Rp.${totalGaji3}
    Total : Rp.${totalGaji}
   `;
}
